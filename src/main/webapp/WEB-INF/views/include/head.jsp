...
<script type="text/javascript" src="${ctxStatic}/jquery-barcode/jquery-barcode.js"></script>
<script type="text/javascript" src="${ctxStatic}/jquery-barcode/jquery-barcode.min.js"></script>