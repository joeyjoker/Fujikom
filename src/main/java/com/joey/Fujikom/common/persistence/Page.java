 ...
 */
package com.joey.Fujikom.common.persistence;

import com.fasterxml.jackson.annotation.JsonIgnore;
import com.joey.Fujikom.common.config.Global;
import com.joey.Fujikom.common.utils.CookieUtils;
...
public class Page<T> {
	...
	public String toString() {
		...
		if (pageNo == first) {// 如果是首页
			sb.append("<li class=\"disabled\"><a href=\"javascript:\">&#171; 前へ</a></li>\n");
		} else {
			sb.append("<li><a href=\"javascript:\" onclick=\""+funcName+"("+prev+","+pageSize+");\">&#171; 前へ</a></li>\n");
		}
		...
		if (pageNo == last) {
			sb.append("<li class=\"disabled\"><a href=\"javascript:\">次へ &#187;</a></li>\n");
		} else {
		...
		sb.append("合計 " + count + " 個"+(message!=null?message:"")+"</a><li>\n");
